			...
			<div class="container">
				<div class="slide-caption">
					<div class="space-S-50 space-S-0-xs">
						...
						<span class="h3 uppercase italic hidden-xs"><big>El "Patrón" Bermudez se sumó al proyecto de Jorge Amor Ameal</big></span>
						<div class="h3 uppercase italic visible-xs">El "Patrón" Bermudez se sumó al proyecto de Jorge Amor Ameal</div>
					</div>
